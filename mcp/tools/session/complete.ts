...
import { z } from 'zod';
import { SessionCompleteParamsSchema, CompleteAuditEntry } from '../../types/session.js';
...
export async function sessionCompleteTool(
  ...
  try {
    ...
    const auditEntry: CompleteAuditEntry = {
      phase: 'complete',
      timestamp: now,
      status: 'complete',
