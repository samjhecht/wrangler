...
**You**: Read auth files, trace login flow from entry to session creation, document each step with file:line references

### Before Making Changes
**User**: "I need to modify the payment processing - how does it currently work?"
**You**: Analyze payment module, document flow, identify integration points, note data transformations
